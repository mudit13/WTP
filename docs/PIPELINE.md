...
#    our fine-tuned head (step 5). GAN Fingerprints (Yu2019) REPRODUCTION in PyTorch
...
#       Path B (CNN): faithful Yu2019 CNN (ganfp_net.py) - FIXED high-pass front-end + 3 VGG
#         conv blocks + GAP + linear (~82K params), trained on luminance tensors. Trains in
