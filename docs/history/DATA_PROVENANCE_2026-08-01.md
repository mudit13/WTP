> **Historical snapshot:** Counts, metrics, and run identifiers below belong to the named earlier run. Use the current release manifest and `docs/DATA_PROVENANCE.md` for final handover evidence.
