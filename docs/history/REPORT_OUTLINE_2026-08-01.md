> **Historical snapshot:** This outline and its writing-source links (`docs/PIPELINE.md`,
> `docs/EXPERIMENT_CATALOG.md`, and the `2026-08-01_eightway_v1` run) belong to an earlier,
> superseded run and documentation layout. Use `docs/RUNBOOK.md`, `docs/METHODOLOGY.md`, and the
> current release manifest under `releases/<release-id>/release.yaml` to draft a report for the
> final server run. The section structure and page budget below remain a reusable starting point.
