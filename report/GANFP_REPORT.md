...
- **Path B — faithful Yu2019 CNN:** a fixed **SRM high-pass front-end** (see §4) + VGG conv
  blocks that **learn** the fingerprints. This is the faithful reproduction of the paper.
